...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE', 'FLUTTERWAVE', 'LEMONSQUEEZY');
...
-- AddForeignKey
ALTER TABLE "RandomData" ADD CONSTRAINT "RandomData_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
